...
const (
	releaseURL     = "https://api.github.com/repos/linkerd/linkerd2/releases"
...
func installation() {
	...
	fmt.Printf("  Downloading linkerd version: %v", linkerdFile.Version)
	linkerdFile.downloadHandler(tempFilePath)

	// move file to .linkerd2/bin and make it executable
